...
static filename_enum_map_t fan_files[] = {
    {"speed"                          , FUSE_FAN_FILETYPE_SPEED},
    {"alert_on"                       , FUSE_FAN_FILETYPE_ALERT},
    {"alias_name"                     , FUSE_FAN_FILETYPE_ALIAS},
    {"diag_mode"                      , FUSE_FAN_FILETYPE_DIAG_MODE}
};

static filename_enum_map_t temperature_files[] = {
    {"temperature"                    , FUSE_THERMAL_SENSOR_FILETYPE_TEMPERATURE},
    {"low_threshold"                  , FUSE_THERMAL_SENSOR_FILETYPE_LOW_THRESHOLD},
    {"high_threshold"                 , FUSE_THERMAL_SENSOR_FILETYPE_HIGH_THRESHOLD},
    {"critical_threshold"             , FUSE_THERMAL_SENSOR_FILETYPE_CRITICAL_THRESHOLD},
    {"alert_on"                       , FUSE_THERMAL_SENSOR_FILETYPE_ALERT_ON},
    {"alias_name"                     , FUSE_THERMAL_SENSOR_FILETYPE_ALIAS},
    {"diag_mode"                      , FUSE_THERMAL_SENSOR_FILETYPE_DIAG_MODE}
};

static filename_enum_map_t led_files[] = {
    {"state"                          , FUSE_LED_FILETYPE_STATE},
    {"alias_name"                     , FUSE_LED_FILETYPE_ALIAS},
    {"diag_mode"                      , FUSE_LED_FILETYPE_DIAG_MODE}
};

static filename_enum_map_t display_led_files[] = {
    {"display_string"                 , FUSE_DISPLAY_LED_FILETYPE_STRING},
    {"state"                          , FUSE_DISPLAY_LED_FILETYPE_STATE},
    {"alias_name"                     , FUSE_DISPLAY_LED_FILETYPE_ALIAS},
    {"diag_mode"                      , FUSE_DISPLAY_LED_FILETYPE_DIAG_MODE}
};

static filename_enum_map_t entity_info_files[] = {
    {"product_name"                   , FUSE_ENTITY_INFO_FILETYPE_PROD_NAME},
    {"ppid"                           , FUSE_ENTITY_INFO_FILETYPE_PPID},
    {"hw_revision"                    , FUSE_ENTITY_INFO_FILETYPE_HW_REVISION},
    {"platform_name"                  , FUSE_ENTITY_INFO_FILETYPE_PLATFORM_NAME},
    {"vendor_name"                    , FUSE_ENTITY_INFO_FILETYPE_VENDOR_NAME},
    {"mac_size"                       , FUSE_ENTITY_INFO_FILETYPE_MAC_SIZE},
    {"base_mac"                       , FUSE_ENTITY_INFO_FILETYPE_BASE_MAC},
    {"num_fans"                       , FUSE_ENTITY_INFO_FILETYPE_NUM_FANS},
    {"max_speed"                      , FUSE_ENTITY_INFO_FILETYPE_MAX_SPEED},
    {"airflow"                        , FUSE_ENTITY_INFO_FILETYPE_AIRFLOW},
    {"power_rating"                   , FUSE_ENTITY_INFO_FILETYPE_POWER_RATING},
    {"alias_name"                     , FUSE_ENTITY_INFO_FILETYPE_ALIAS},
    {"service_tag"                    , FUSE_ENTITY_INFO_FILETYPE_SERVICE_TAG},
    {"diag_mode"                      , FUSE_ENTITY_INFO_FILETYPE_DIAG_MODE}
};

static filename_enum_map_t media_files[] = {
    {"media_presence"                , FUSE_MEDIA_FILETYPE_PRESENCE},
    /** module status */
    {"media_status_temp_high_alarm"  , FUSE_MEDIA_FILETYPE_TEMP_HIGH_ALARM_STATUS},
    {"media_status_temp_low_alarm"   , FUSE_MEDIA_FILETYPE_TEMP_LOW_ALARM_STATUS},
    {"media_status_temp_high_warning", FUSE_MEDIA_FILETYPE_TEMP_HIGH_WARNING_STATUS},
    {"media_status_temp_low_warning" , FUSE_MEDIA_FILETYPE_TEMP_LOW_WARNING_STATUS},
    {"media_status_volt_high_alarm"  , FUSE_MEDIA_FILETYPE_VOLT_HIGH_ALARM_STATUS},
    {"media_status_volt_low_alarm"   , FUSE_MEDIA_FILETYPE_VOLT_LOW_ALARM_STATUS},
    {"media_status_volt_high_warning", FUSE_MEDIA_FILETYPE_VOLT_HIGH_WARNING_STATUS},
    {"media_status_volt_low_warning" , FUSE_MEDIA_FILETYPE_VOLT_LOW_WARNING_STATUS},

    /** channel status 1..4 */
    {"media_status_tx_disable"       , FUSE_MEDIA_FILETYPE_TX_DISABLE_STATUS},
    {"media_status_tx_fault"         , FUSE_MEDIA_FILETYPE_TX_FAULT_STATUS},
    {"media_status_tx_loss"          , FUSE_MEDIA_FILETYPE_TX_LOSS_STATUS},
    {"media_status_rx_loss"          , FUSE_MEDIA_FILETYPE_RX_LOSS_STATUS},

    /** media transmission control 1..4 */
    {"media_tx_control"              , FUSE_MEDIA_FILETYPE_TX_CONTROL},
    {"media_speed"                   , FUSE_MEDIA_FILETYPE_SPEED},
    {"media_dell_qualified"          , FUSE_MEDIA_FILETYPE_DELL_QUALIFIED},

    /** parameter */
    {"media_wavelength"              , FUSE_MEDIA_FILETYPE_WAVELENGTH},
    {"media_wavelength_tolerance"    , FUSE_MEDIA_FILETYPE_WAVELENGTH_TOLERANCE},
    {"media_max_case_temp"           , FUSE_MEDIA_FILETYPE_MAX_CASE_TEMP},
    {"media_cc_base"                 , FUSE_MEDIA_FILETYPE_CC_BASE},
    {"media_cc_ext"                  , FUSE_MEDIA_FILETYPE_CC_EXT},
    {"media_connector"               , FUSE_MEDIA_FILETYPE_CONNECTOR},
    {"media_encoding_bitrate"        , FUSE_MEDIA_FILETYPE_ENCODING_BITRATE},
    {"media_identifier"              , FUSE_MEDIA_FILETYPE_IDENTIFIER},
    {"media_ext_identifier"          , FUSE_MEDIA_FILETYPE_EXT_IDENTIFIER},
    {"media_length_smf_km"           , FUSE_MEDIA_FILETYPE_LENGTH_SMF_KM},
    {"media_length_om1"              , FUSE_MEDIA_FILETYPE_LENGTH_OM1},
    {"media_length_om2"              , FUSE_MEDIA_FILETYPE_LENGTH_OM2},
    {"media_length_om3"              , FUSE_MEDIA_FILETYPE_LENGTH_OM3},
    {"media_length_cable_assembly"   , FUSE_MEDIA_FILETYPE_LENGTH_CABLE_ASSEMBLY},
    {"media_diag_mon_type"           , FUSE_MEDIA_FILETYPE_DIAG_MON_TYPE},
    {"media_length_smf"              , FUSE_MEDIA_FILETYPE_LENGTH_SMF},
    {"media_options"                 , FUSE_MEDIA_FILETYPE_OPTIONS},
    {"media_enhanced_options"        , FUSE_MEDIA_FILETYPE_ADVANCED_OPTIONS},

    /** vendor information */
    {"media_vendor_name"             , FUSE_MEDIA_FILETYPE_VENDOR_NAME},
    {"media_vendor_oui"              , FUSE_MEDIA_FILETYPE_VENDOR_OUI},
    {"media_vendor_sn"               , FUSE_MEDIA_FILETYPE_VENDOR_SN},
    {"media_vendor_date"             , FUSE_MEDIA_FILETYPE_VENDOR_DATE},
    {"media_vendor_pn"               , FUSE_MEDIA_FILETYPE_VENDOR_PN},
    {"media_vendor_revision"         , FUSE_MEDIA_FILETYPE_VENDOR_REVISION},

    /** dell product information */
    {"dell_media_info_magic_key0"    , FUSE_MEDIA_FILETYPE_DELL_INFO_MAGIC_KEY0},
    {"dell_media_info_magic_key1"    , FUSE_MEDIA_FILETYPE_DELL_INFO_MAGIC_KEY1},
    {"dell_media_info_revision"      , FUSE_MEDIA_FILETYPE_DELL_INFO_REVISION},
    {"dell_media_info_product_id"    , FUSE_MEDIA_FILETYPE_DELL_INFO_PRODUCT_ID},
    {"dell_media_info_reserved"      , FUSE_MEDIA_FILETYPE_DELL_INFO_RESERVED},

    /** module threshold */
    {"media_threshold_temp_high_alarm"  , FUSE_MEDIA_FILETYPE_TEMP_HIGH_ALARM_THRESHOLD},
    {"media_threshold_temp_low_alarm"   , FUSE_MEDIA_FILETYPE_TEMP_LOW_ALARM_THRESHOLD},
    {"media_threshold_temp_high_warning", FUSE_MEDIA_FILETYPE_TEMP_HIGH_WARNING_THRESHOLD},
    {"media_threshold_temp_low_warning" , FUSE_MEDIA_FILETYPE_TEMP_LOW_WARNING_THRESHOLD},
    {"media_threshold_volt_high_alarm"  , FUSE_MEDIA_FILETYPE_VOLT_HIGH_ALARM_THRESHOLD},
    {"media_threshold_volt_low_alarm"   , FUSE_MEDIA_FILETYPE_VOLT_LOW_ALARM_THRESHOLD},
    {"media_threshold_volt_high_warning", FUSE_MEDIA_FILETYPE_VOLT_LOW_ALARM_THRESHOLD},
    {"media_threshold_volt_low_warning" , FUSE_MEDIA_FILETYPE_VOLT_LOW_WARNING_THRESHOLD},

    /** channel threshold 1..4 */
    {"media_threshold_tx_disable"       , FUSE_MEDIA_FILETYPE_TX_DISABLE_THRESHOLD},
    {"media_threshold_tx_fault"         , FUSE_MEDIA_FILETYPE_TX_FAULT_THRESHOLD},
    {"media_threshold_tx_loss"          , FUSE_MEDIA_FILETYPE_TX_LOSS_THRESHOLD},
    {"media_threshold_rx_loss"          , FUSE_MEDIA_FILETYPE_RX_LOSS_THRESHOLD},
    {"media_lp_mode"                    , FUSE_MEDIA_FILETYPE_LP_MODE},
    {"media_reset"                      , FUSE_MEDIA_FILETYPE_RESET},

    /** per media module */
    {"media_volt"                       , FUSE_MEDIA_FILETYPE_VOLT},
    {"media_temperature"                , FUSE_MEDIA_FILETYPE_TEMPERATURE},

    /** per channel 1..4 */
    {"media_internal_rx_power_monitor"  , FUSE_MEDIA_FILETYPE_INTERNAL_RX_POWER_MONITOR},
    {"media_internal_tx_power_bias"     , FUSE_MEDIA_FILETYPE_INTERNAL_TX_POWER_BIAS},
    
    {"alias_name"                       , FUSE_MEDIA_FILETYPE_ALIAS},
    {"diag_mode"                        , FUSE_MEDIA_FILETYPE_DIAG_MODE}
};
        ...
        )
{
    if(count == FILETYPE_PATH_LEN && 
        ...
        node->st_size = FUSE_FILE_DEFAULT_SIZE;
        return;
    }

    node->st_size = FUSE_DIR_DEFAULT_SIZE;
    return;
}
    ...
    if(strcmp(temp_path, "/") == 0) {
        if(!safestrncpy(node->path, temp_path, FUSE_FUSE_MAX_PATH)) {
            ...
            EV_LOG_INFO(ev_log_t_PAS, 
                    3, 
                    "PAS", 
                    "Issue assigning path,  path pointer is NULL\n"); 
            node->valid = false;
            return;
        }
        ...
        )
{
    ...
    st.st_size = tmp_dev_node.st_size;
