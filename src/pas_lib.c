                               ...
                               )
{
    ...
    *qual = cps_api_key_get_qual(key);
    ...
    if ((*led_name_valid = (a != 0))) {
        *led_name     = (char *) cps_api_object_attr_data_bin(a);
        *led_name_len = cps_api_object_attr_len(a);
    }
}
                               ...
                               )
{
    ...
    *qual = cps_api_key_get_qual(key);
    ...
    if ((*disp_name_valid = (a != 0))) {
        *disp_name     = (char *) cps_api_object_attr_data_bin(a);
        *disp_name_len = cps_api_object_attr_len(a);
    }
}
                               ...
                               )
{
    ...
    *qual = cps_api_key_get_qual(key);
    ...
    if ((*sensor_name_valid = (a != 0))) {
        *sensor_name     = (char *) cps_api_object_attr_data_bin(a);
        *sensor_name_len = cps_api_object_attr_len(a);
    }
}
